  ...
  const onAdd = async function (newClothesObj) {
    ...
    if (uri) {
      try {
        ...
        await writeToDB({
          title: newClothesObj.title,
          imageUri: newClothesObj.imageUri,
          photoUri: newClothesObj.photoUri,
          content: newClothesObj.content,
          location: newClothesObj.location,
          likes: newClothesObj.likes,
          dislikes: newClothesObj.dislikes,
          api: newClothesObj.api,
        });
      } catch (err) {
  ...
  return (
    <ScrollView style={styles.addNew}>
      <View style={styles.addNewTitle}>
        <Text style={styles.addNewTitle}>Title</Text>
        <TextInput
          value={text}
      ...
      <View style={styles.addNewContent}>
        <Text style={styles.addNewTitle}>Content</Text>
        <TextInput
          value={content}
      ...
      <View style={styles.addNewTitle}>
        <Text style={styles.addNewTitle}>Shopping Link</Text>
        <TextInput
          value={api}
          onChangeText={(newApi) => {
            onChangeApi(newApi);
